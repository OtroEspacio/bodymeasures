...
ActiveRecord::Schema.define(version: 20160223033522) do
  ...
  create_table "body_measures", force: :cascade do |t|
    ...
    t.string   "hombro"
    t.string   "c_de_busto"
    t.string   "al_de_busto"
    t.string   "s_de_busto"
    t.string   "m_inf_de_busto"
    t.string   "m_de_cadera"
    t.string   "cintura"
    t.string   "l_de_manga_pecho"
    t.string   "c_de_manga_pecho"
    t.string   "l_de_m_corta"
    t.string   "c_de_m_corta"
    t.string   "l_de_manga_3_4"
    t.string   "c_de_manga_3_4"
    t.string   "l_de_blusa"
    t.string   "escote"
    t.string   "l_de_rodilla"
    t.string   "c_de_rodilla"
    t.string   "l_de_t"
    t.string   "l_total"
    t.string   "c_de_bota"
    t.text     "nota"
